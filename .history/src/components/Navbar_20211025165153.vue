<template>
  ...
  style="position: fixed, width: 100%"
    :class="{
      ...
      'pos-fix-nav': showMobileMenu||GET_HORIZON_POSITION_SCROLL>0,
    }"
  >
    <header class="header wrapper">
      <nav class="flex-center-between">
        <div @click="showMobileMenu = false">
          <router-link to="/" v-if="!showTransparentNavbar||GET_HORIZON_POSITION_SCROLL>0">
            <img src="../assets/logo1.svg" alt="logo" class="header-logo" />
          </router-link>
          <router-link to="/" v-else>
            <img
              v-if="showMobileMenu||GET_HORIZON_POSITION_SCROLL>0"
        ...
        <ul
          ...
          :class="{'menu-white-color':showTransparentNavbar}"
        >
          <li class="menu__item">
            <router-link to="/404" :class="{'menu-color':GET_HORIZON_POSITION_SCROLL>0}">Downloads</router-link>
          </li>
          <li class="menu__item">
            <router-link to="/ecosystem" :class="{'menu-color':GET_HORIZON_POSITION_SCROLL>0}">Ecosystem</router-link>
          </li>
          <li class="menu__item">
            <router-link to="/team" :class="{'menu-color':GET_HORIZON_POSITION_SCROLL>0}">The Team</router-link>
          </li>
          <li class="menu__item">
            <router-link to="/investors" :class="{'menu-color':GET_HORIZON_POSITION_SCROLL>0}">Investors</router-link>
          </li>
        </ul>
        <div
