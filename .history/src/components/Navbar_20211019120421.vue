<template>
  <div :class="{'bg-gray' : !showTransparentNavbar,'main-navbar':showTransparentNavbar,'pos-fix-nav':showMobileMenu}" >
      ...
      <nav class="flex-center-between" >
        <div @click="showMobileMenu = false">
          ...
          <router-link to="/" v-else  >
            ...
            <img v-if="!showMobileMenu" src="../assets/images/logo-white.svg" alt="logo" class="header-logo" />
          </router-link>
        </div>
        ...
        <div v-else class="menu-icon" @click="showMobileMenu = !showMobileMenu">
          <img   v-if="!showMobileMenu"  src="../assets/menu-white-icon.svg" alt="menu-icon" width="40" />
           <img  v-if="showMobileMenu"  src="../assets/menu.png" alt="menu-icon" width="40" />
        </div>
        <transition name="slide">
          <ul
          
              class="menu flex"
              v-if="showMobileMenu"  :class="{ 'show-mobile-menu flex-center-center pos-fix' : showMobileMenu}"
          >
